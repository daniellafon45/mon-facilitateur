-- Seed script for test user (run with service role after auth user created)
-- Create user via: supabase auth admin or Dashboard > Authentication > Add user
-- Email: test@test.com  Password: test123

-- This migration documents the expected seed; actual auth.users insert requires service role.
-- Use scripts/seed-test-user.mjs with SUPABASE_SERVICE_ROLE_KEY
